    ...
    <Suspense>
      <Await
        ...
        children={(orders) => (
          ...
          >
            {orders.length != 0 ? <div className="pt-5 pl-md-5 pt-lg-8 pl-lg-9 space-bottom-lg-2 mb-lg-4">
            ...
            </div> :  <div className="pt-5 pl-md-5 pt-lg-8 pl-lg-9 space-bottom-lg-3"><h6 className="font-weight-medium font-size-7 ml-lg-1 mb-lg-8 pb-xl-1">Danh sách đơn hàng trống</h6></div>}
          </div> 
        )}
      />
    </Suspense>
